...
Revision ID: 0010_chat_family
Revises: 005_lab_reports
...
(down_revision = ('004_lab_tests', '0009')). 005_lab_reports is therefore the
...
revision = "0010_chat_family"
down_revision = "005_lab_reports"
branch_labels = None
depends_on = None
