...
# All endpoints now use phone OTP user_id by default
...
async def get_user_from_token(
    ...
    """Backward compatible - returns user object"""
    return await get_current_user_unified(token, db)


# Legacy tenant membership support (for analytics router)
class CurrentMembership:
    ...
    async def __call__(
        ...
        # Phone users dont have tenant memberships
        return None
